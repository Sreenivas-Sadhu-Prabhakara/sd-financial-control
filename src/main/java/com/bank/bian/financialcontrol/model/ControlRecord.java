package com.bank.bian.financialcontrol.model;
...
/**
 * The BIAN control record for this service domain: "Financial Control Record Management Plan".
 *
 ...
 * to its asset type (Financial Control Record). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Financial Control Record Management Plan";
